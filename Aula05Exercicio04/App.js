...
import Slider from '@react-native-community/slider';  // Atualizado para usar o slider da nova biblioteca

const App = () => {
    const [text, setText] = useState('');  // Estado para o valor do TextInput
    ...
    return (
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.view}>
                ...
                <ActivityIndicator animating={isLoading} size="large" color="#0000ff" style={styles.activityIndicator} />
            </View>
...
const styles = StyleSheet.create({
    ...
    activityIndicator: {
        marginTop: 20,
        alignSelf: 'center',  // Centraliza o indicador de carregamento
    },
    sliderContainer: {
        marginTop: 20,
    ...
    slider: {
        width: 300,  // Define a largura do slider
